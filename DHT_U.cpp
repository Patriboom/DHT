 ...
 */
void DHT_Unified::setName(AdafruitDHT_sensor_t *sensor) {
  switch (_type) {
  case DHT11:
 ...
 *          Sensor that will be set
 */
void DHT_Unified::setMinDelay(AdafruitDHT_sensor_t *sensor) {
  switch (_type) {
  case DHT11:
...
/*!
 *  @brief  Provides the AdafruitDHT_sensor_t data for this sensor
 *  @param  sensor
 */
void DHT_Unified::Temperature::getSensor(AdafruitDHT_sensor_t *sensor) {
  // Clear sensor definition.
  memset(sensor, 0, sizeof(AdafruitDHT_sensor_t));
  // Set sensor name.
 ...
 *  @param  sensor
 */
void DHT_Unified::Humidity::getSensor(AdafruitDHT_sensor_t *sensor) {
  // Clear sensor definition.
  memset(sensor, 0, sizeof(AdafruitDHT_sensor_t));
  // Set sensor name.
  _parent->setName(sensor);
